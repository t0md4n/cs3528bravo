...
const Login = () => {
 ...
 // consume our user-management context to
 // get & set the user details here
 const { user, fetchUser, emailPasswordLogin } = useContext(UserContext);
 
 // use React's "useState" hook to keep track
 // of the form values
 ...
 // will be called whenever the user edits the form.
 ...
 // checking if the user is already logged in and
 ...
 const onSubmit = async (event) => {
   try {
     // we are passing user details to our emailPasswordLogin
